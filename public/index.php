...
if (isset ($_SERVER['HTTP_X_WAP_PROFILE']) || preg_match('/Android/', $_SERVER['HTTP_USER_AGENT']) || preg_match('/\(i[^;]+;( U;)? CPU.+Mac OS X/', $_SERVER['HTTP_USER_AGENT'])) {
    // echo "<img src='/public/images/pc.jpg'>";
 ...
 */
  ...
  {
    // add by willy 2014-12-02 fixed the bug for register_shutdown_function because the function only use absolute file path
    define('APPPATH', str_replace("\\", "/", realpath(FCPATH . $application_folder) .'/'));
  }
  else
  {

...
function play_show(obj, group_id) {
    ...
    if (icon_url == "<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/down.png") {
       obj.find("img").attr("alt", "收缩二级菜单");
        obj.find("img").attr("src", "<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/advance.png");
        $(".sub_"+group_id).hide();
    } else {
       obj.find("img").attr("alt", "展开二级菜单");
        obj.find("img").attr("src", "<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/down.png");
        $(".sub_"+group_id).show();
    }
}
...
function update_display(obj, group_id) {
    ...
    if (is_display.val() == 1) {
       is_display.val('0');
       obj.html('<img alt="隐藏" src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/view_no.png">隐藏');
    } else {
       is_display.val('1');
        obj.html('<img alt="显示" src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/view_yes.png">显示');
    }
}
...
function add_menu()
{
    ...
    htmls += '<tr class="item">';
        ...
        htmls += '<td><a href="javascript:;" onclick="update_display($(this), '+group_id+')" ><img alt="显示" src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/view_yes.png">显示</a>';
            htmls += '<input type="hidden" name="menu['+group_id+'][is_display]" value="1" />';
        htmls += '</td>';
        htmls += '<td>';
            htmls += '<a href="javascript:;" onclick="add_column($(this), '+group_id+')"><img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/add_2.png" alt="Add"/>添加二级菜单</a>';
            htmls += '&nbsp;<a style="cursor:pointer;" href="javascript:;" onclick="play_show($(this), '+group_id+');"><img src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/advance.png" alt="展开菜单"/>展开二级菜单</a>';
            htmls += '&nbsp;<a href="javascript:;" onclick="del($(this))"><img src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/cancel.png" alt="删除" />删除</a>';
        htmls += '</td>';
    htmls += '</tr>';
...
function add_column(obj, group_id)
{
    ...
    htmls += '<tr class="sub_'+group_id+'" menuid="'+group_id+'" style="background:#ccc;" >';
        ...
        htmls += '</td>';
        htmls += '<td>';
            htmls += '<a href="javascript:;" onclick="$(this).parent().parent().remove()"><img src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/cancel.png" alt="删除" />删除</a>';
    ...
    obj.parent().find("img").eq(1).attr("src", "<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/down.png");
}
                   ...
                   <?php if(count($list)){ foreach($list as $item){ ?>
                     ...
                     <tr class="item">
                        ...
                        <td>
                           <a href="javascript:;" onclick="update_display($(this), <?php echo $item['sysGroupId']?>)" >
                               <?php if($item['is_display'] == 1){?>
                                    <img alt="显示" src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/view_yes.png">显示
                                <?php }else{ ?>
                                    <img alt="隐藏" src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/view_no.png">隐藏
                                <?php } ?>
                            </a>
                        ...
                        <td>
                            ...
                            <a href="javascript:;" onclick="add_column($(this), <?php echo $item['sysGroupId']; ?>)"><img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/16/add_2.png" alt="Add"/>添加二级菜单</a>

                            <a style="cursor:pointer;" href="javascript:;" onclick="play_show($(this), <?php echo $item['sysGroupId']; ?>);">
                                <img src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/advance.png" alt="展开菜单"/>展开二级菜单
                            </a>
                            <a href="javascript:;" onclick="del($(this));"><img src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/cancel.png" alt="删除" />删除</a></td>
                        </td>
                    </tr>
                       ...
                       <td><input type="text" name="menu[<?php echo $val['sysGroupId']; ?>][sub][<?php echo $key; ?>][sort]" class="input" style="width:30px;" maxlength="2" value="<?php echo $val['sort']; ?>" /></td>
                        ...
                        <td>
                           <input type="hidden" name="menu[<?php echo $val['sysGroupId']; ?>][sub][<?php echo $key; ?>][id]" value="<?php echo $val['id']; ?>" />
                            <a href="javascript:;" onclick="$(this).parent().parent().remove()"><img src="<?php echo HOME_DOMAIN; ?>public/images/admin/icons/16/cancel.png" alt="删除" />删除</a>
                        </td>
                   </tr>

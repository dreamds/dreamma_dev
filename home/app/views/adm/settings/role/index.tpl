<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <div class="content-box">
                ...
                <div class="content-box-content">
                        <form name="search_form" method="get" action="<?php echo HOME_DOMAIN; ?>adm_role/" class="search-content">
                            <table>
                            <colgroup>
                                    <col width="10%"/>
                                    <col width="20%"/>
                        ...
                        <table class="list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo HOME_DOMAIN; ?>adm_role/editRole/?id=<?php echo $item['id']; ?>"><img src="<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/edit_2.png" alt="编辑"/>编辑</a>
                                        <a href="<?php echo HOME_DOMAIN; ?>adm_role/manageUser/?id=<?php echo $item['id']; ?>"><img src="<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/group.png" alt="编辑"/>成员管理</a>
                                        <a href="<?php echo HOME_DOMAIN; ?>adm_role/priv/?id=<?php echo $item['id']; ?>"><img src="<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/auth.png" alt="编辑"/>权限管理</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
    ...
    <!--
        $(document).ready(function(){
           ...
           $('#addRole').click(function(){
                window.location = '<?php echo HOME_DOMAIN; ?>adm_role/addRole';
           });
    -->
</script>
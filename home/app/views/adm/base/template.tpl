<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="#"><span>
                    <img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/pencil_48.png" alt="icon"><br>
                    快捷方式1
                </span></a></li>
                
                <li><a class="shortcut-button" href="#"><span>
                    <img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/paper_content_pencil_48.png" alt="icon"><br>
                    快捷方式2
                </span></a></li>
                
                <li><a class="shortcut-button" href="#"><span>
                    <img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/image_add_48.png" alt="icon"><br>
                    快捷方式3
                </span></a></li>
                
                <li><a class="shortcut-button" href="#"><span>
                    <img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/clock_48.png" alt="icon"><br>
                    快捷方式4
                </span></a></li>
                
                <li><a class="shortcut-button" href="#messages" rel="modal"><span>
                    <img src="<?php echo HOME_DOMAIN ?>public/images/admin/icons/comment_48.png" alt="icon"><br>
                    快捷方式5
                </span></a></li>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr class="alt-row">
                                    ...
                                    <td>
                                        <!-- base/icons -->
                                         <a href="#" title="Edit"><img src="public/images/admin/icons/pencil.png" alt="Edit"></a>
                                         <a href="#" title="Delete"><img src="public/images/admin/icons/cross.png" alt="Delete"></a>
                                         <a href="#" title="Edit Meta"><img src="public/images/admin/icons/hammer_screwdriver.png" alt="Edit Meta"></a>
                                    </td>
                                </tr>

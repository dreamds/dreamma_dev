...
<head>
    ...
    <title><?php echo  ADM_TITLE; ?><?php if($title){echo ' - '.$title;} ?></title>
    <?php echo  css_tag(array('admin/base.css'),$css) ?>
    <?php echo  script_tag(array('jquery/jquery-1.8.3.min.js', 'layer/layer.js', 'laydate/laydate.js', 'jquery/jquery.validate.1.9.min.js','jquery/jquery.metadata.js', 'My97DatePicker/WdatePicker.js', 'admin/base.js', 'admin/validate.js', 'jquery/plugins/jquery.form.js'), $js) ?>
    <!--[if IE 6]>
...
<?php if(!in_array($_SERVER['REQUEST_URI'], array('/adm_auth', '/admin/siderbar')) && $_GET['nobar'] !== '1') { ?>
<table border="0" width="100%" class="content-box-header" style="border-radius:0;margin: 0 5px;">
    <tr>
        ...
        <td width="50%">
            ...
            <a href="<?php echo  HOME_DOMAIN; ?>" target="_blank" ><img src="<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/home.png" alt="查看前台"/>查看前台</a>&nbsp;|&nbsp;
            <a onclick="$.BKD.open('iframe', '<?php echo  HOME_DOMAIN ?>adm_auth/reset_password?nobar=1', '400px', '340px')" href="#"><img src="<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/editpwd.png" alt="修改密码"/>修改密码</a>&nbsp;|&nbsp;
            <a target="_parent" href="<?php echo  HOME_DOMAIN ?>adm_auth/loginout" ><img src="<?php echo HOME_DOMAIN;?>public/images/admin/icons/16/loginout.png" alt="登出"/>登出</a>
            </h3>
        </td>
    </tr>
</table>
